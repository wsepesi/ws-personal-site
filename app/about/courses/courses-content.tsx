...
const coursesOther: Omit<Course, 'textbooks'>[] = [
  {
    title: "CONTEMPORARY ART HISTORY: NEW MEDIA, NEW TECHNOLOGIES",
    prof: "Ila Sheren",
    number: "AA 3973"
  },
  {
          ...
          return (
            <div key={course.number}>
              <div className="flex flex-col sm:flex-row sm:items-end">
                <p className="text-lg">{course.title} ({course.number}),&nbsp;</p>
                <p className="italic sm:not-italic">{course.prof}</p>
              </div>
