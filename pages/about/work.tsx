...
const positions: Position[] = [
    ...
    },
    {
        ...
        bullets: [
            "Pioneered effort to deconstruct legacy service Ledger, responsible for all balance tracking at Square",
    ...
    },
    {
        ...
        bullets: [
            "Used MaskRCNN for boundary detection and ConvNeXT for classification of pedestrian clothing type and coloration, deploying both to embedded devices on client cameras",
    ...
    },
    {
        ...
        description: "Researched and implemented methods for anomaly detection in high-dimensional time series data generated by large scale distributed systems.",
        bullets: [
