...
export default function Home() {
  ...
  return (
    <>
      <SEO
        title={siteTitle}
        description={`${fullName} - Machine learning researcher and engineer specializing in reinforcement learning and LLMs. Former Microsoft, Square engineer.`}
        url={SITE_URL}
