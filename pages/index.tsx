      ...
      <SiteBase title={isMobile ? "william[dot]computer":"william [dot] computer"}>
        <div className="flex flex-col-reverse md:flex-row">
          <div className="flex-1">
            ...
            <p className="mt-4">
              My interests lie across reinforcement learning (particularly incomplete information), LLMs (particularly local models), mechanistic interpretability and information theory. I&apos;ve <Link href="/about/work" className="underline hover:italic">worked as an ML engineer and researcher</Link> at Microsoft, Square, and a handful of startups in these areas and beyond. I&apos;ve also been the Head Teaching Assistant for a variety of ML courses during my undergrad.
            </p>
            <p className="mt-4">
